...
| **17** | Study task completion rate, tool call accuracy, number of steps to completion, and cost per task in regards to Agent Evaluation. | ✅ Done | [Learnings](week3/day17/learnings.md) • [Code](week3/day17/code/) |
